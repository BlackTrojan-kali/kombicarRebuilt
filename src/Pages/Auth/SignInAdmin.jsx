...
    }
    ...
    // Validation ajoutée : Vérifie si le mot de passe a au moins 8 caractères
    if (password.length < 8) {
        setError('Le mot de passe doit avoir au moins 8 caractères.');
        return; // Arrête la soumission du formulaire ici
    }
...
                type="submit"
                disabled={loading}
                className={`w-full flex justify-center py-2 px-4 border border-transparent rounded-lg shadow-sm text-sm font-bold text-black transition-colors duration-200
