...
import Select from 'react-select'; // Importez la bibliothèque react-select
import Input from "../../Components/form/Input";
import FormButton from "../../Components/form/FormButton";
import { Toaster, toast } from 'react-hot-toast'; // Importation de Toaster et toast
import useAuth from '../../hooks/useAuth'; // Assurez-vous que le chemin est correct

export default function Signup() {
  const { register, loading } = useAuth(); // Utilisation du hook useAuth pour accéder à la fonction d'inscription et à l'état de chargement
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    password: "",
    country: null, // Changez la valeur initiale à null pour react-select
