...
import useAuth from '../hooks/useAuth'; // <-- Utilisation du hook personnalisé
...
  // Récupération du contexte d'authentification via le hook useAuth
...
  // Détermination du pays actuel pour la HeroSection
...
      {/* Envoi des props à HeroSection pour gérer l'affichage du sélecteur de pays */}
      <HeroSection 
        label={"BIENVENUE SUR KOMBICAR"}
        showCountrySelect={!user && !authLoading && defaultCountry} // Afficher la sélection seulement si non connecté et pays chargé
